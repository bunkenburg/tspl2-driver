 ...
 */
@Slf4j public class EthernetConnectionClientTest {

    private TcpServerMock server;
    private TSPLConnectionClient connectionClient;

    @BeforeEach public void startTCPEmulator() throws IOException, InterruptedException {
    ...
    @AfterEach public void clear() throws InterruptedException {
