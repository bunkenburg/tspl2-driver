...
public class CounterTest {
    ...
    @Test public void testSetCounterIncrement() {
    ...
    @Test public void testSetCounterDecrement() {
    ...
    @Test public void testSetCounterIncrement_2() {
        Counter counter = Counter.builder().counterNumber(2).step(1).build();
    ...
    @Test public void testSetCounterIncrement_3() {
        Counter counter = Counter.builder().counterNumber(2).step(+1).build();
