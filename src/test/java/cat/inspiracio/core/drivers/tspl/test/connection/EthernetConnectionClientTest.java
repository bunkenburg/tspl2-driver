 ...
 */
package cat.inspiracio.core.drivers.tspl.test.connection;

import lombok.extern.slf4j.Slf4j;
import cat.inspiracio.core.drivers.tspl.commands.status.TSPLStatusPollCommands;
import cat.inspiracio.core.drivers.tspl.connection.EthernetConnectionClient;
import cat.inspiracio.core.drivers.tspl.connection.TSPLConnectionClient;
import cat.inspiracio.core.drivers.tspl.exceptions.ConnectionClientException;
import cat.inspiracio.core.drivers.tspl.listeners.ClientListener;
import cat.inspiracio.core.drivers.tspl.listeners.DataListener;
import cat.inspiracio.core.drivers.tspl.test.TcpServerMock;
