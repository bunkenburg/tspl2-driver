...
import static cat.inspiracio.core.drivers.tspl.DriverConstants.*;
...
public class Text implements TSPLCommand {
    ...
    public String getCommand() {
        ...
        if (!TSPLLabelUtils.hasFloatDecimals(xMultiplicationFactor)) {
        ...
        if (!TSPLLabelUtils.hasFloatDecimals(yMultiplicationFactor)) {
